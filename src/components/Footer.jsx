...
const Footer = () => {
  return (
    <>
      <div className='wrapper bg-gray-100  items-center ' >
        <div className="container h-36  flex gap-5">
          <div className="footerbox w-full h-full  text-[#002f34] ml-32 ">
          ...
          <div className="footerbox w-full h-full  mr-32  text-[#002f34]">
          ...
          <div className="footerbox w-full h-full  pr-10 text-[#002f34]">
            <div className='text-sm font-semibold leading-7 mt-3'>ABOUT US</div>
            <div className='text-xs leading-6'>Contact Us</div>
          </div>
          <div className="footerbox w-full h-full mx-1  text-[#002f34]">
          ...
          <div className="footerbox w-full h-full mx-1 ">
      ...
      <div className="bg-[#002f34] items-center ">
        <div className='container mx-auto h-16  flex justify-between text-white text-xs items-center' >
          <h1 className="mx-32" >minhal©rights</h1>
          <h1 className="mx-32"  >All rights reserved © 2006-2024 OLX</h1>
        </div>
      </div>
